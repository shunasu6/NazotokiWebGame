...
window.addEventListener("DOMContentLoaded", () => {
    ...
    function kotae()
    {
    if(f.q1.value == "りもこん" || f.q1.value == "リモコン" || f.q1.value == "ドーナツ" || f.q1.value == "どーなつ" || f.q1.value == "LEVEL1_CLEARE___01011") {
    ...
    function kotae2()
    {
    if(f2.q1.value == "delete" || f2.q1.value == "DELETE" || f2.q1.value == "Delete" || f2.q1.value == "どーなつ" || f2.q1.value == "LEVEL2_CLEARE___01011") {
