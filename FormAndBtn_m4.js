...
window.addEventListener("DOMContentLoaded", () => {
    ...
    function kotae()
    {
    if(f.q1.value == "Copy" || f.q1.value == "copy" || f.q1.value == "COPY" || f.q1.value == "どーなつ" || f.q1.value == "LEVEL1_CLEARE___01011") {
    ...
    function kotae2()
    {
    if(f2.q1.value == "ドーナッツ" || f2.q1.value == "どーなっつ" || f2.q1.value == "ドーナツ" || f2.q1.value == "どーなつ" || f2.q1.value == "LEVEL2_CLEARE___01011") {
